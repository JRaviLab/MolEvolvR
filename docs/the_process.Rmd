...
prot <- read_delim("data/rawdata_tsv/all_merged_gca_taxid.txt",
...
prot <- prot %>% mutate(Species.new = Species.q )
rows_na <- which(is.na(prot$Species.new))
prot$Species.new[rows_na] <- prot$Species.orig[rows_na]
