...
# Cleanup Clusters
prot <- prot %>%
  cleanup_clust(TRUE,domains_keep, domains_rename)
...
# Cleanup GenContext
prot <- prot %>%
  cleanup_gencontext(TRUE) #TRUE? Calls RevOperons?
...
prot <- prot %>%
  cleanup_domarch(TRUE, domains_rename) # shouldn't call domains_ignore
