...
convert_aln2fa(input_file=dropdown_aln,
               lin=prot,
               output_path=paste0("data/alns/", dropdown_var, ".fasta"),
               reduced=F)
# reduced version for MSA?
convert_aln2fa(input_file=dropdown_aln,
               lin=prot,
               output_path=paste0("data/alns/", dropdown_var, "_red.fasta"),
               reduced=T)

msa_pdf(fasta_filepath=paste0(here("data/alns/"), dropdown_var, "_red.fasta"),
