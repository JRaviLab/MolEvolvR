...
submit_full <- function(dir = "/data/scratch", DB = Sys.getenv("BLAST_DB"), NHITS = Sys.getenv("BLAST_HITS"), EVAL = Sys.getenv("BLAST_EVALUE"), sequences = "~/test.fa", phylo = "FALSE", by_domain = "FALSE", domain_starting = "~/domain_seqs.fa", type = "full", job_code=NULL, submitter_email=NULL, advanced_options=NULL, get_slurm_mails=FALSE) {
...
submit_ipr <- function(dir = "/data/scratch", ipr = "~/test.fa", seqs = "seqs.fa", ncbi = FALSE, blast = FALSE, DB = Sys.getenv("BLAST_DB"), NHITS = Sys.getenv("BLAST_HITS"), EVAL = Sys.getenv("BLAST_EVALUE"), job_code=NULL, submitter_email=NULL, advanced_options=NULL, get_slurm_mails=FALSE) {
  setwd(dir)
