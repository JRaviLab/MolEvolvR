...
if(length(params$repAccNums) >= 3 ) {
  ...
  msa_subdir_path <- file.path(parent_dir, "msa_figs")
  if (!dir.exists(subdir_path)) {
    dir.create(subdir_path, recursive = TRUE)
    message("Subdirectory 'msa_figs' created at: ", subdir_path)
  } else {
    message("Subdirectory 'msa_figs' already exists at: ", subdir_path)
  }
