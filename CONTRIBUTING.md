...
This outlines how to propose a change to MolEvolvR. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  this before, we recommend using `usethis`.
...
- Install other development dependencies and then ensure that the
  package passes R CMD check using `devtools`:
...
- Lint Your Code: Ensure your code adheres to our style guidelines by
...
Code of
Conduct](https://jravilab.github.io/MolEvolvR/CODE_OF_CONDUCT.md). By
